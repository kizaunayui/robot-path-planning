...
const MOCK_PATHS = [
  { id: 'A', label: 'A 最优路径', color: 'green', distance: 120, time: 8, energy: 15, risk: '低', desc: '经主大厅直达，路径最短' },
  { id: 'B', label: 'B 备用路径', color: 'yellow', distance: 185, time: 13, energy: 22, risk: '中', desc: '绕行走廊，避开高峰区域' },
  { id: 'C', label: 'C 应急路径', color: 'red', distance: 240, time: 18, energy: 30, risk: '低', desc: '经电梯间迂回，最安全但最远' },
]

...
export default function PathConfig() {
  ...
  return (
    <div className="p-6 space-y-4">
      <h2 className="text-2xl font-bold text-slate-100">⚙️ 动态路径规划配置</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-5 shadow-sm">
          <h3 className="text-sm font-bold text-slate-200 mb-3">算法优先级</h3>
            ...
            {ALGORITHMS.map((a) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-medium text-sm text-slate-200">{a.name}</span>
                </div>
        ...
        <div className="space-y-4">
          <div className="bg-slate-800 rounded-lg border border-slate-700 p-5 shadow-sm">
            <h3 className="text-sm font-bold text-slate-200 mb-3">路径规划灵敏度</h3>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-slate-400">灵敏度等级</span>
                <span className="text-slate-200 font-bold">{params.sensitivity}</span>
              </div>
              <input
                type="range"
                min={1}
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 p-5 shadow-sm">
            <h3 className="text-sm font-bold text-slate-200 mb-3">缓冲距离</h3>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-slate-400">障碍物缓冲</span>
                <span className="text-slate-200 font-bold">{params.buffer}</span>
              </div>
              <input
                type="range"
                min={0}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-5 shadow-sm">
          <h3 className="text-sm font-bold text-slate-200 mb-3">手动操作</h3>
          <div className="space-y-2">
            <button
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-5 shadow-sm">
          <h3 className="text-sm font-bold text-slate-200 mb-3">当前策略状态</h3>
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-slate-200">{params.sensitivity}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-400">缓冲</span>
              <span className="text-slate-200">{params.buffer}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-5 shadow-sm">
          <h3 className="text-sm font-bold text-slate-200 mb-3">最优路径摘要</h3>
          {bestRoute ? (
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-slate-400">策略</span>
                <span className="text-slate-200">{bestRoute.name}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">长度</span>
                <span className="text-slate-200">{bestRoute.length} 步</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">转弯</span>
                <span className="text-slate-200">{bestRoute.turns} 次</span>
              </div>
              <div className="flex justify-between">

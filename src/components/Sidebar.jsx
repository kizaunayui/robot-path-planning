...
const navItems = [
  ...
  { path: '/charging', icon: '🔋', label: '充电管理' },
  { path: '/diagnostics', icon: '📍', label: '诊断' },
  { path: '/map-editor', icon: '🗺️', label: '地图编辑' },
  { path: '/task-dispatch', icon: '📦', label: '任务派发' },
  { path: '/path-config', icon: '⚙️', label: '路径配置' },
  { path: '/traffic-rules', icon: '🚦', label: '交通规则' },
  { path: '/simulation', icon: '🎮', label: '模拟沙盒' },
]
